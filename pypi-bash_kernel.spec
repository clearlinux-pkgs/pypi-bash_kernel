...
%prep
%setup -q -n bash_kernel-0.7.2
cd %{_builddir}/bash_kernel-0.7.2
pushd ..
cp -a bash_kernel-0.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656360922
...
cp %{_builddir}/bash_kernel-0.7.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-bash_kernel/76c7e710d472be20ce886472767e77a7d52692b8
